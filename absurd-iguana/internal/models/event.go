...
// EventResponse provides a standarized schema for all API feedback.
// Ensuring consistent response shapes helps client-side consumers
// handle success and error states predictably.
